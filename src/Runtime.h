...
#include "Growify/SystemConditionController.h"
#include "Apis/Apis.h"
#include "cert_key.h"
...
private:
    ...
    Growify* growify;
    SystemConditionController* systemConditionController;
...
void Runtime::update()
{
    ...
    growify->update();
    systemConditionController->update();
}
